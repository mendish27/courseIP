...
public class changeEmail extends HttpServlet {
        ...
        class Form{
            private static String makeForm(HttpServletRequest request) {
                return "<html><head>"
                        ...
                        + "</head><body>"
                        +"<h2 align=\"center\" style=\"margin-top: 10%\" border=\"1\">Смена почты: </h2>"
                        ...
                        +"Введите старый email: </td>  <td valign=\"top\">"
                        +"<input type=\"text\" name=\"lastEmail\" size=\"20\">"
                        +"</td></tr><tr><td valign=\"top\">"
                        +"Введите новый email: </td>  <td valign=\"top\">"
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println(changeEmail.HTMLGenerator.Form.makeForm(request));
    }
}
